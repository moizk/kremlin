...
class CompetitorsControllerTest < ActionController::TestCase
  ...
  test "should create competitor" do
    assert_difference('Competitor.count') do
      post :create, competitor: { facebook: @competitor.facebook, name: @competitor.name, twitter: @competitor.twitter, website: @competitor.website }
    end
  ...
  test "should update competitor" do
    put :update, id: @competitor, competitor: { facebook: @competitor.facebook, name: @competitor.name, twitter: @competitor.twitter, website: @competitor.website }
    assert_redirected_to competitor_path(assigns(:competitor))
  end
